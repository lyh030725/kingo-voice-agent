...
class MvpTests(unittest.TestCase):
    ...
    def test_course_agent_symbol_states_are_wired(self) -> None:
        ...
        self.assertNotIn("course-agent-breathe", component)
        self.assertNotIn("course-agent-halo", component)
        self.assertIn("course-agent-flow 1.5s linear infinite", component)
